...
public class CarServiceFunctionalTest {
    ...
    public void testBooking() {
        ...
        assertEquals("{\"status\":400,\"error\":\"Bad Request\",\"message\":\"Only minute is valid!!!\",\"path\":\"/services/cars/book\"}"
                , pattern.matcher(send("/services/cars/book", "{\"customerName\":\"John Smith\",\"customerAddress\":\"Kobago utca 3\",\"customerID\":\"AXC\",\"carId\":1,\"usage\":\"DOMESTIC\",\"from\":1521126720000,\"to\":1521123920000}")).replaceAll(""));
        assertEquals("{\"status\":400,\"error\":\"Bad Request\",\"message\":\"Minimum rent time: 1 hour!!!\",\"path\":\"/services/cars/book\"}"
                , pattern.matcher(send("/services/cars/book", "{\"customerName\":\"John Smith\",\"customerAddress\":\"Kobago utca 3\",\"customerID\":\"AXC\",\"carId\":1,\"usage\":\"DOMESTIC\",\"from\":1521126000000,\"to\":1521126060000}")).replaceAll(""));
        assertEquals("{\"status\":400,\"error\":\"Bad Request\",\"message\":\"Invalid Period\",\"path\":\"/services/cars/book\"}"
                , pattern.matcher(send("/services/cars/book", "{\"customerName\":\"John Smith\",\"customerAddress\":\"Kobago utca 3\",\"customerID\":\"AXC\",\"carId\":1,\"usage\":\"DOMESTIC\",\"from\":1521126060000,\"to\":1521126000000}")).replaceAll(""));
        assertEquals("{\"status\":400,\"error\":\"Bad Request\",\"message\":\"Usage has invalid value: aaa!!! Valid Values: DOMESTIC and FOREIGN\",\"path\":\"/services/cars/book\"}"
                , pattern.matcher(send("/services/cars/book", "{\"customerName\":\"John Smith\",\"customerAddress\":\"Kobago utca 3\",\"customerID\":\"AXC\",\"carId\":1,\"usage\":\"aaa\",\"from\":"+sysTimestamp(1)+",\"to\":"+sysTimestamp(3)+"}")).replaceAll(""));
        assertEquals("{\"status\":400,\"error\":\"Bad Request\",\"message\":\"In case of foreign usage country code must be specified!!!\",\"path\":\"/services/cars/book\"}"
                , pattern.matcher(send("/services/cars/book", "{\"customerName\":\"John Smith\",\"customerAddress\":\"Kobago utca 3\",\"customerID\":\"AXC\",\"carId\":1,\"usage\":\"FOREIGN\",\"from\":"+sysTimestamp(1)+",\"to\":"+sysTimestamp(3)+"}")).replaceAll(""));

        assertEquals("{\"accepted\":true}"
                , pattern.matcher(send("/services/cars/book", "{\"customerName\":\"John Smith\",\"customerAddress\":\"Kobago utca 3\",\"customerID\":\"AXC\",\"carId\":1,\"usage\":\"DOMESTIC\",\"from\":"+sysTimestamp(1)+",\"to\":"+sysTimestamp(3)+"}")).replaceAll(""));
