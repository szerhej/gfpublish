...
public class CarServiceFunctionalTest {
    ...
    public void testBooking() {
        ...
        assertEquals("{\"status\":400,\"error\":\"Bad Request\",\"message\":\"Unknown Country: KG!!! \",\"path\":\"/services/cars/book\"}"
                , pattern.matcher(send("/services/cars/book", "{\"customerName\":\"John Smith\",\"customerEmail\":\"a@a.com\",\"customerAddress\":\"Kobago utca 3\",\"customerID\":\"AXC\",\"carId\":1,\"usage\":\"FOREIGN\",\"countries\":[\"KG\"],\"from\":"+sysTimestamp(1)+",\"to\":"+sysTimestamp(3)+"}")).replaceAll(""));
